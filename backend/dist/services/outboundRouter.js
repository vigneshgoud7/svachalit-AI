...
class OutboundRouter {
     ...
     */
    static async sendResponse(payload) {
     ...
     */
    static async sendWhatsAppMessage(phone, text) {
     ...
     */
    static async sendInstagramMessage(igId, text) {
     ...
     */
    static async sendFacebookMessage(fbId, text) {
     ...
     */
    static async sendVoiceResponse(callSid, text) {
